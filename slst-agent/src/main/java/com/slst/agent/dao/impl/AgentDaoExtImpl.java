package com.slst.agent.dao.impl;

import com.slst.agent.dao.AgentDaoExt;
 ...
 */
public class AgentDaoExtImpl extends JpaDaoSupport<Agent, Long>  implements AgentDaoExt {
